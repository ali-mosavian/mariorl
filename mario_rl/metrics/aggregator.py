...
class MetricAggregator:
    ...
    def aggregate(self) -> dict[str, Any]:
        ...
        """
        worker_snaps_raw = [self._snapshots.get(f"worker.{i}") for i in range(self.num_workers)]
        worker_snaps: list[dict[str, Any]] = [s for s in worker_snaps_raw if s is not None]
