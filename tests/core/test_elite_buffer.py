...
from mario_rl.core.elite_buffer import EliteBuffer, EliteTransition
...
class TestEliteBufferBasics:
    """Tests for basic EliteBuffer functionality."""
    ...
    def test_add_single_transition(self, sample_transition: Transition) -> None:
    ...
    def test_add_episode(self, sample_transition: Transition) -> None:
    ...
    def test_add_episode_with_flag(self, sample_transition: Transition) -> None:
...
class TestEliteBufferCapacity:
    """Tests for capacity management."""

    def test_fills_to_capacity(self, sample_transition: Transition) -> None:
    ...
    def test_replaces_lowest_quality(self, sample_transition: Transition) -> None:
    ...
    def test_rejects_lower_quality_when_full(self, sample_transition: Transition) -> None:
...
class TestEliteBufferSampling:
    """Tests for sampling from the buffer."""

    def test_cannot_sample_empty(self) -> None:
        """Test sampling from empty buffer returns None."""
        buffer = EliteBuffer(capacity=100)
        result = buffer.sample(10)
        assert result is None

    def test_sample_returns_tensors(self, sample_transition: Transition) -> None:
    ...
    def test_sample_respects_batch_size(self, sample_transition: Transition) -> None:
    ...
    def test_sample_device_placement(self, sample_transition: Transition) -> None:
    ...
    def test_can_sample(self, sample_transition: Transition) -> None:
...
class TestEliteBufferQuality:
    """Tests for quality computation."""

    def test_quality_includes_max_x(self) -> None:
    ...
    def test_quality_includes_flag_bonus(self) -> None:
    ...
    def test_quality_includes_reward_bonus(self) -> None:
    ...
    def test_quality_composite(self) -> None:
...
class TestEliteBufferStats:
    ...
    def test_stats_with_data(self, sample_transition: Transition) -> None:
    ...
    def test_total_added_count(self, sample_transition: Transition) -> None:
    ...
    def test_unique_episodes(self, sample_transition: Transition) -> None:
...
class TestEliteBufferMinQualityThreshold:
    """Tests for minimum quality threshold."""

    def test_rejects_below_threshold(self, sample_transition: Transition) -> None:
    ...
    def test_accepts_above_threshold(self, sample_transition: Transition) -> None:
    ...
    def test_episode_rejected_below_threshold(self, sample_transition: Transition) -> None:
...
class TestEliteTransition:
    """Tests for EliteTransition dataclass."""

    def test_create_elite_transition(self, sample_transition: Transition) -> None:
    ...
    def test_elite_transition_frozen(self, sample_transition: Transition) -> None:
