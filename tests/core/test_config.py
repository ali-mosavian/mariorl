...
class TestEpsilonFloor:
    """Tests for per-worker epsilon calculation.
    ...
    def test_default_epsilon_base(self) -> None:
        """Default epsilon_base should be 0.15 for low floor."""
        config = TrainingConfig()
        assert config.epsilon_base == 0.15

    def test_epsilon_floor_with_4_workers(self) -> None:
    ...
    def test_epsilon_floor_calculation_formula(self) -> None:
    ...
    def test_old_epsilon_base_was_too_high(self) -> None:
