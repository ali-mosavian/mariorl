...
class TestMetricsTrackerInit:
    ...
    def test_initial_histories_empty(self) -> None:
...
class TestAddTimeout:
    """Tests for MetricsTracker.add_timeout() method."""

    def test_add_timeout_increments_counter(self) -> None:
    ...
    def test_add_timeout_does_not_affect_deaths(self) -> None:
    ...
    def test_timeout_and_death_independent(self) -> None:
...
class TestAddDeath:
    """Tests for MetricsTracker.add_death() method."""

    def test_add_death_increments_counter(self) -> None:
    ...
    def test_add_death_records_position(self) -> None:
    ...
    def test_death_history_limit(self) -> None:
...
class TestAddFlag:
    """Tests for MetricsTracker.add_flag() method."""

    def test_add_flag_increments_counter(self) -> None:
    ...
    def test_add_flag_records_time(self) -> None:
...
class TestEpisodeEndTracking:
    """Tests for tracking episode endings (death vs timeout vs flag)."""

    def test_episode_end_types_sum_correctly(self) -> None:
    ...
    def test_timeout_not_recorded_as_death_position(self) -> None:
...
class TestAverages:
    ...
    def test_avg_x_at_death(self) -> None:
