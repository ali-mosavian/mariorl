...
class TestPrioritizedReplayBufferFlagPriority:
    """Tests for flag priority multiplier in PrioritizedReplayBuffer."""

    def test_flag_priority_multiplier_default(self, obs_shape: tuple[int, ...]) -> None:
    ...
    def test_flag_priority_multiplier_custom(self, obs_shape: tuple[int, ...]) -> None:
...
class TestTransitionFlagGetField:
    """Tests for flag_get field in Transition."""

    def test_transition_default_flag_get(self) -> None:
    ...
    def test_transition_default_max_x(self) -> None:
    ...
    def test_transition_with_flag_get(self) -> None:
...
class TestBufferConfigFlagPriority:
    """Tests for flag priority in BufferConfig."""
    ...
    def test_buffer_config_custom(self) -> None:
