...
def test_delegates_to_all_collectors_on_episode_end(composite: CompositeCollector, mock_collectors: list[MagicMock]) -> None:
...
def test_delegates_to_all_collectors_on_train_step(composite: CompositeCollector, mock_collectors: list[MagicMock]) -> None:
